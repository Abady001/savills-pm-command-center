...
## Corpus Check
- 56 files · ~26,637 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 613 nodes · 570 edges · 47 communities (38 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7bda21c8`
...
9. `Convex Performance Audit` - 10 edges
10. `Fix Order` - 10 edges
...
Cohesion: 0.07
Nodes (29): Agent Mode, Checklist, code:bash (npx convex dev --once), code:tsx (// Bad: re-creates the client on every render), code:tsx (// src/main.tsx), code:tsx (// app/ConvexClientProvider.tsx), code:tsx (// app/layout.tsx), code:bash (CONVEX_AGENT_MODE=anonymous npx convex dev --once) (+21 more)
...
Cohesion: 0.09
Nodes (11): http, svixId, svixSignature, svixTimestamp, wh, addNumber, listNumbers, myAction (+3 more)
...
Cohesion: 0.14
Nodes (14): code:bash (npm create convex@latest my-app -- -t owner/repo), code:bash (npm create convex@latest my-app -- -t react-vite-shadcn), code:bash (npm create convex@latest . -- -t react-vite-shadcn), code:bash (npx convex dev --once), code:bash (CONVEX_AGENT_MODE=anonymous npx convex dev --once), code:bash (npm run dev), code:bash (npx convex dev), code:block8 (my-app/) (+6 more)
...
## Knowledge Gaps
- **406 isolated node(s):** `version`, `source`, `sourceType`, `skillPath`, `computedHash` (+401 more)
...
- **Why does `Convex Quickstart` connect `Community 6` to `Community 16`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `Path 1: New Project (Recommended)` connect `Community 16` to `Community 6`?**
